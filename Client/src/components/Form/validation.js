const validation = (data) => {
  ...
  if (data.email !== "pedroloria003@gmail.com") {
  ...
  if (!passwordRegexp.test(data.password)) {
    errors.password =
      "Debe contener letras y numeros, ademas tiene que tener una longitud entre 6 y 10 caracteres";
  }
  if (data.password !== "pedro123") {
